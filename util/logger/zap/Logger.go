...
func initConsoleLogger() { // for logging to the console
	encoder := getEncoder()
...
func NewFileLogger() *zap.SugaredLogger {
	initFileLogger()
	return zap.S()
}

var ConsoleModule = fx.Provide(NewConsoleLogger)
var FileModule = fx.Provide(NewFileLogger)
/*
Documentation:
Language: go
